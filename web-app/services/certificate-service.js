...
function mergeCertificateData(dbRecordArray, ledgerRecordArray) {
    ...
    for (let i = 0; i < dbRecordArray.length ; i++) {
        ...
        certMergedDataArray.push({
            ...
            studentRegistrationNumber: dbEntry.studentRegistrationNumber,
            ...
            transcripts: dbEntry.transcripts || [],
            additionalInfoNotes: dbEntry.additionalInfoNotes,
            additionalInfoFiles: dbEntry.additionalInfoFiles || []
        });
    }

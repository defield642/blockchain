...
const issueUpload = upload.fields([
    { name: "transcriptYear1", maxCount: 1 },
    { name: "transcriptYear2", maxCount: 1 },
    { name: "transcriptYear3", maxCount: 1 },
    { name: "transcriptYear4", maxCount: 1 },
    { name: "additionalInfoFiles", maxCount: 5 }
]);
...
router.get('/reset', function(req, res, next) {
    universityController.getResetPage(req, res, next);
});
...
router.post("/issue", issueUpload, universityController.postIssueCertificate);
...
router.post('/reset/request', universityController.postResetRequest);
router.post('/reset/confirm', universityController.postResetConfirm);

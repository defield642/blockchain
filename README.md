...
**Verifier/employer**
* Receive addresses from students and verify it.
* View and recruit best student.




**How to run it on linux machine**
...
4. Start the web app
    ...
    npm run start-development
    ```
>>>>>>> 75b2397 (Initial commit: add chaincode, README, web-app)

**On windows**

Use WLS(Windows Subsystem for Linux) or Docker desktop because of hyperledger fabric which can be run on linux system only then follow same step 